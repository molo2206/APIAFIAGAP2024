...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('pathologies_prise_charges', function (Blueprint $table) {
            ...
            $table->foreignUuid('maladieid')->constrained('t_maladie');
    ...
    {
        Schema::dropIfExists('pathologies_prise_charge');
    }
};
