...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('sante_sexuelles', function (Blueprint $table) {
            $table->uuid('id')->primary();
            $table->foreignUuid('activiteid')->constrained('t_activite_projets')->onUpdate('cascade')->onDelete('cascade');
            $table->foreignUuid('type_sante_sexuelle_id')->constrained('type_sante_sexuelles');
    ...
    {
        Schema::dropIfExists('sante_sexuelles');
    }
};
